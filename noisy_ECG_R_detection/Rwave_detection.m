function [R_detections]=Rwave_detection(signal,PLFREQ)

   fs = 1000; 
   fil_signal = Filter_sig(signal,PLFREQ,fs);

    % 1) square:   
    sqr_signal = (fil_signal).^2;
